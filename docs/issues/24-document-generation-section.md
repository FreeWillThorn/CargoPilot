...
- 单证阻塞项 must use an internal scroll container so long blocker lists do not push the rest of 海运单证 off screen.
...
- Long blocker lists scroll inside the 单证阻塞项 panel.

## Triage Revision Notes

> *This was generated by AI during triage.*

- 2026-06-26: Confirmed 海运单证 单证阻塞项 uses `document-blocker-scroll`.
