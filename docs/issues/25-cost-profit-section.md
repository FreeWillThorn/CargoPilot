...
- 货物项报价表 must show the summed Goods Line sales value for the selected Import Order.
...
- 2026-06-26: Confirmed 成本利润 needs section totals, not only editable line rows. 货物项报价表 displays 货物销售总值, cost/charge tables display 合计 rows, and 客户收费明细 includes an add/入账 drawer with 入账金额 and 入账日期.
